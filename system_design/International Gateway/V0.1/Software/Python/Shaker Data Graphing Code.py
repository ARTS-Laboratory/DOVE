...
train_files = [
    f'{original_data_folder}/006.csv', # sweep 1-20.9 Hz
    f'{original_data_folder}/008.csv', # 1 Hz
    f'{original_data_folder}/009.csv', # 5 Hz
    f'{original_data_folder}/010.csv', # 8 Hz
    f'{original_data_folder}/011.csv', # 10 Hz
    f'{original_data_folder}/012.csv', # 15 Hz
    f'{original_data_folder}/013.csv', # 20 Hz
    f'{compensation_data_folder}/C006.CSV', # Gain = 1.0
    f'{compensation_data_folder}/C007.CSV', # Gain = 0.8
    f'{compensation_data_folder}/C008.CSV', # Gain = 1.5
    f'{compensation_data_folder}/C009.CSV', # Gain = 2
    f'{compensation_data_folder}/C010.CSV' # Gain = 2.5 
]
...
for file in train_files:
    ...
    #%%%%%%%%%%%%%%%%%%% change to for i in range(lstm_window_size, len(filtered_scaled), stride):
...
X_test = []
y_test = []
#%%%%%%%%%%%%%%%%%%% change to for i in range(lstm_window_size, len(filtered_test_scaled), stride):
...
#%%%%%%%% change this line above to be this:
# prediction_indices = np.arange(lstm_window_size,len(filtered_test_scaled),stride))
# prediction_time = tt_test[prediction_indices]
